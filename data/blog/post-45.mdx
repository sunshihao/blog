...
在学习 Vue 或者 React 的时候，我们应该都使用过它们的脚手架工具（[[create-vue](https://github.com/vuejs/create-vue)](https://github.com/vuejs/create-vue)、[[create-react-app](https://github.com/facebook/create-react-app)](https://github.com/facebook/create-react-app)）。通过脚手架我们能够快速得到一个 Vue 或者 React 项目，我们无需将经历花在了项目基础骨架搭建上，能够更加快速的开发业务
